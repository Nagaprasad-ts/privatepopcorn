    ...
    <section className="relative w-full h-[70vh] min-h-[500px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="container relative z-20 px-4">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
                <Button asChild size="lg" className="bg-red-500 hover:bg-red-600/90 text-white font-medium text-md shadow-lg shadow-accent/20 transition-all hover:scale-105">
                    <Link href="#book">Book Your Moment</Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-black/50 text-black hover:bg-black/5 hover:text-black transition-all hover:scale-105 font-medium text-md">
